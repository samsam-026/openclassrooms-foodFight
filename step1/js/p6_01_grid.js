class Grid {
    ...
    checkNeighbours(x, y) {
        ...
        for (let i = 0; i < xDirections.length; i++) {
            ...
            if (this.withinRange(this.gridHeight, newY) && this.withinRange(this.gridWidth, newX) && !this.grid[newX][newY].isEmpty()) {
                return false;
            }
    ...
    withinRange(range, value) {
        return 0 <= value && value < range;
    }
